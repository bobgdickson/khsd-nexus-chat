...
"""
    ...
    # Normalize to dict form so build_sql can treat both the same way.
    normalized_filters = [
    ...
    try:
        sql, params = build_sql(entity, select, normalized_filters, limit, normalized_order_by)
...
if __name__ == "__main__":
    ...
    args = {
        "entity": "GL_SUMMARY",
        "select": ["fiscal_year", "department", "object", "amount"],
        "filters": [
